...
$languageArray= [ "dripfeeds.title" => "Drip-feed", 
 ...
 "signup.accept_terms_text" => "<a href='terms'> Membership agreement</a> I have read, I accept the terms", 
 ...
 "neworder.recheck" => " Yes, I Have Confirmed the Order ", 
 "services.id" => "ID", 
 ...
 "account.tabs.data" => "Profile data",
 "account.tabs.security" => "Security",
 "account.tabs.avatar" => "Avatar",
 "account.tabs.finance" => "Financial summary",
 "account.display_name" => "Display name",
 "account.bio" => "Bio",
 "account.profile.save" => "Save profile",
 "account.profile.validation.display_name" => "Display name must be between 3 and 80 characters.",
 "account.profile.validation.basic" => "Please check profile fields length and try again.",
 "account.profile.update.success" => "Profile information updated successfully.",
 "account.profile.update.fail" => "Unable to update profile information.",
 "account.avatar.upload" => "Upload personal image",
 "account.avatar.hint" => "Allowed files: JPG, PNG, WEBP. Maximum size: 2 MB.",
 "account.avatar.button" => "Update image",
 "account.avatar.validation.required" => "Please choose an image before upload.",
 "account.avatar.validation.size" => "Image size must be 2 MB or smaller.",
 "account.avatar.validation.type" => "Invalid image type. Allowed types: JPG, PNG, WEBP.",
 "account.avatar.update.success" => "Profile image updated successfully.",
 "account.avatar.update.fail" => "Unable to upload profile image.",
 "account.summary.deposit" => "Total deposits",
 "account.summary.spent" => "Total spending",
 "account.summary.balance" => "Current balance",
 "account.summary.avg_order" => "Average order value",
 "account.summary.total_orders" => "Total orders",
 "account.summary.completed_orders" => "Completed orders",
 "account.summary.pending_payments" => "Pending payments",
 ...
 "smmspot.login.information.description2" => "We are always with you for all your questions and problems. Our priority is our customer satisfaction. We always protect your customer privacy data.", 
 "smmspot.login.information.button2" => "View Services", 
 "smmspot.login.information.title3" => "Enjoy the Privileges...", 
 "smmspot.login.information.description3" => "As Smm Panel Social Media Dealership Panel, you have no doubt that we will always offer you the most appropriate and highest quality services.", 
 ...
 "admin.layout.header.toggle_navigation" => "Toggle navigation", 
 "admin.header.nav.users" => "Users", 
 "admin.header.nav.orders" => "Orders", 
 "admin.header.nav.subscriptions" => "Subscriptions", 
 "admin.header.nav.dripfeed" => "Drip-feed", 
 "admin.header.nav.tasks" => "Tasks", 
 "admin.header.nav.services" => "Services", 
 "admin.header.nav.payments" => "Payments", 
 "admin.header.nav.support" => "Support", 
 "admin.header.nav.appearance" => "Appearance", 
 "admin.header.nav.settings" => "Settings", 
 "admin.header.nav.additionals" => "Additionals", 
 "admin.header.nav.statistics" => "Statistics", 
 "admin.header.nav.logs" => "Logs", 
 "admin.header.nav.child_panels" => "Child Panels", 
 "admin.header.nav.admin" => "Admin", 
 "admin.header.nav.logout" => "Logout", 
 "admin.appearance.menu.pages" => "Pages", 
 "admin.appearance.menu.announcements" => "Announcements", 
 "admin.appearance.menu.blog" => "Blog", 
 "admin.appearance.menu.menu" => "Menu", 
 "admin.appearance.menu.themes" => "Themes", 
 "admin.appearance.menu.languages" => "Languages", 
 "admin.appearance.menu.folders" => "Folders", 
 "panel.layout.demo.choose_theme" => "Choose Theme:", 
 "panel.verify.notification.subject" => "Verify your account.", 
 "panel.verify.notification.body" => "Your verification link: ", 
 "panel.verify.error.prefix" => "Verification failed: ", 
];
