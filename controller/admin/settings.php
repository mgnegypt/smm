...
$menuList = ["General" => "general", "Cron Settings" => "crons", "Providers" => "providers", "Payment methods" => "payment-methods", "modules" => "modules", "Integrations" => "integrations", "Notifications" => "alert", "Bonuses" => "payment-bonuses","Currency"=>"currency" ];
