            ...
            if ( $insert && $update && $insert2 ):
              ...
              $_SESSION["data"]["order"]      = $order_data;
                ...
                if( $settings["alert_newmanuelservice"] == 2 ):
                  ...
                  if( $sendmail ):
                    sendMail(["subject"=>"Bir sipariş.","body"=>"Websiteniz #".$last_id." idli yeni bir sipariş mevcut.","mail"=>$settings["admin_mail"]]);
                  endif;
                endif;
            else:
              $conn->rollBack();
              ...
              if( $service_detail["service_package"] == 1 || $service_detail["service_package"] == 2 ):
                ...
                if( @!$order->order ):
                  ...
                  if( $sendsms ):
                    ...
                    SMSUser($settings["admin_telephone"],"Web siteniz'de bir sipariş gönderilemedi. ".$glyconRand);
                  endif;
                  if( $sendmail ):
                    sendMail(["subject"=>"Bir sipariş gönderilemedi.","body"=>"Websiteniz'de bir sipariş gönderilemedi.","mail"=>$settings["admin_mail"]]);
                  endif;
                  endif;
